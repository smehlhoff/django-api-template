...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'username', 'location', 'bio', 'date_joined')
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('username', 'email', 'location', 'bio',
...
class ResetPasswordConfirmSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            raise exceptions.ParseError(
                'This uid is not associated with an account.')

        if not default_token_generator.check_token(user, attrs['token']):
            raise exceptions.ParseError('This token is invalid.')
...
class VerifyEmailConfirmSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        if not email_token_generator.check_token(user, attrs['token']):
            raise exceptions.ParseError('This token is invalid.')

        user.primary_email.set_verified()
